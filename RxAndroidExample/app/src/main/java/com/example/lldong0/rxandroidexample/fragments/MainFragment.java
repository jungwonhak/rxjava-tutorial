...
import com.example.lldong0.rxandroidexample.activities.thread.PollingFragment;
import com.example.lldong0.rxandroidexample.fragments.recyclerview.RecyclerViewFragment;
import com.example.lldong0.rxandroidexample.network.square.OkHttpFragment;
import com.example.lldong0.rxandroidexample.network.volley.VolleyFragment;
...
//
    ...
    void demoClickRecycle() {
        startDemo(new RecyclerViewFragment());
    }
    ...
    void demoPolling() {
        startDemo(new PollingFragment());
    }

    @OnClick(R.id.btn_click_observer)
    void demoClickObserver() {
